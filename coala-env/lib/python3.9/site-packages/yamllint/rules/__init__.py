...
from yamllint.rules import (braces, brackets, colons, commas, comments,
                            comments_indentation, document_end, document_start,
                            empty_lines, hyphens, indentation, key_duplicates,
                            line_length, new_line_at_end_of_file, new_lines,
