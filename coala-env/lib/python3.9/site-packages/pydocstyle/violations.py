...
class Error(object):
    ...
    def lines(self):
        ...
        numbers_width = 6
        for n, line in enumerate(lines_stripped):
            source += "{{0}}{0}: {{1}}".format(numbers_width).format(n + offset, line)
...
D200 = D2xx.create_error(
    "D200", "One-line docstring should fit on one line " "with quotes", "found {0}"
)
D201 = D2xx.create_error(
    "D201", "No blank lines allowed before function " "docstring", "found {0}"
)
D202 = D2xx.create_error(
    "D202", "No blank lines allowed after function " "docstring", "found {0}"
)
...
D211 = D2xx.create_error(
    "D211", "No blank lines allowed before class " "docstring", "found {0}"
)
...
D401 = D4xx.create_error(
    "D401", "First line should be in imperative mood", "{0!r}, not {1!r}"
)
