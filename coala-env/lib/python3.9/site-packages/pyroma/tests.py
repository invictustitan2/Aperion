...
class RatingsTest(unittest.TestCase):
    ...
    def test_minimal(self):
        directory = resource_filename(__name__, os.path.join("testdata", "minimal"))
        data = projectdata.get_data(directory)
        rating = rate(data)
    ...
    def test_lacking(self):
        directory = resource_filename(__name__, os.path.join("testdata", "lacking"))
        data = projectdata.get_data(directory)
        rating = rate(data)
    ...
    def test_custom_test(self):
        directory = resource_filename(__name__, os.path.join("testdata", "custom_test"))
        data = projectdata.get_data(directory)
        rating = rate(data)
