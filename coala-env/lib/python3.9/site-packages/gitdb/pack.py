...
from gitdb.exc import (AmbiguousObjectName, BadObject, ParseError,
                       UnsupportedOperation)
from gitdb.fun import (OFS_DELTA, REF_DELTA, chunk_size,
...
from gitdb.util import LazyMixin, bin_to_hex, byte_ord, mman, unpack_from
...
from gitdb.base import (ODeltaPackInfo, ODeltaPackStream,  # Amazing !
                        ODeltaStream, OInfo, OPackInfo, OPackStream, OStream)
from gitdb.const import NULL_BYTE
from gitdb.stream import (DecompressMemMapReader, DeltaApplyReader,
                          FlexibleSha1Writer, NullStream, Sha1Writer)
