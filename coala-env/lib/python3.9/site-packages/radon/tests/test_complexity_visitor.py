...
class TestSingleFunctions(ParametrizedTestCase):
    ...
    def test_ComplexityVisitor(self):
        ...
        self.assertEqual(
            (visitor.complexity, visitor.functions[0].complexity),
...
class TestFunctions(ParametrizedTestCase):
    ...
    def test_ComplexityVisitor(self):
        ...
        self.assertEqual(
            tuple(map(GET_COMPLEXITY, visitor.functions)), self.expected_complexity
        )
...
class TestClasses(ParametrizedTestCase):
    ...
    def test_ComplexityVisitor(self):
        ...
        self.assertEqual(
            tuple(map(GET_COMPLEXITY, cls.methods)), self.methods_complexity
        )
...
class TestModules(ParametrizedTestCase):
    ...
    def test_module(self):
        ...
        self.assertEqual(visitor.functions_complexity, self.functions_complexity)
