...
class TestBaseHarvester(ConfigMixin, unittest.TestCase):
    ...
    def test_iter_filenames(self, iter_mock):
        ...
        iter_mock.assert_called_with([], self.config.exclude, self.config.ignore)
    ...
    def test_results(self):
        ...
        self.assertEqual(list(results), [{"file-0": 0}, {"file-1": 1}, {"file-2": 4}])
...
class TestCCHarvester(ConfigMixin, unittest.TestCase):
    ...
    def test_gobble(self, cc_mock, sr_mock):
        ...
        cc_mock.assert_called_with(mock.sentinel.one, no_assert=self.config.no_assert)
    ...
    def test_to_terminal(self, c2t_mock, ranks_mock, reset_mock):
        ...
        self.assertEqual(
            ...
            [
                ...
                ("Average complexity: {0}{1} ({2}){3}", ("<|A|>", "A", 3, "__R__"), {}),
            ],
        )
