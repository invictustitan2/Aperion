...
class TestIterFilenames(unittest.TestCase):
    ...
    def test_all(self, os_mod, os_path_mod):
        ...
        self.assertPEqual(
            self.iter_files(["file.py", "random/path"]),
            [
                "file.py",
                "amod.py",
                "test_all.py",
        ...
        self.assertPEqual(
            self.iter_files(["file.py", "random/path"], "test_*"),
            [
                "file.py",
                "amod.py",
                "tests/test_amod.py",
        ...
        self.assertPEqual(
            self.iter_files(["file.py", "random/path"], "*/test_*,amod*"),
            ["file.py", "test_all.py", "tests/run.py", "sub/amod.py", "sub/bmod.py"],
        )

        self.assertPEqual(
            self.iter_files(["file.py", "random/path"], None, "tests"),
            ["file.py", "amod.py", "test_all.py", "sub/amod.py", "sub/bmod.py"],
        )

        self.assertPEqual(
            self.iter_files(["file.py", "random/path"], None, "tests,sub"),
...
class TestDictConversion(unittest.TestCase):
    ...
    def test_raw_to_dict(self):
        self.assertEqual(
            tools.raw_to_dict(Module(103, 123, 98, 8, 19, 5, 3)),
            {
                "loc": 103,
                "lloc": 123,
                "sloc": 98,
...
class TestCCToTerminal(unittest.TestCase):
    ...
    def test_cc_to_terminal(self):
        ...
        self.assertEqual(
            tools.cc_to_terminal(results, False, "A", "F", False), (res_noshow, 120, 6)
        )
        self.assertEqual(
            tools.cc_to_terminal(results, True, "A", "F", False), (res, 120, 6)
        )
        self.assertEqual(
            tools.cc_to_terminal(results, True, "A", "D", False), (res[:-2], 47, 4)
        )
        self.assertEqual(
            tools.cc_to_terminal(results, False, "A", "D", False),
            (res_noshow[:-2], 47, 4),
        )
        self.assertEqual(
            tools.cc_to_terminal(results, True, "C", "F", False), (res[2:], 109, 4)
        )
        self.assertEqual(
            tools.cc_to_terminal(results, True, "B", "E", False), (res[1:-1], 75, 4)
        )
        self.assertEqual(
            tools.cc_to_terminal(results, True, "B", "F", True), (res[1:], 120, 6)
        )
