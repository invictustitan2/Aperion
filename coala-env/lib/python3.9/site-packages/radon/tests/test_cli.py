...
class TestConfig(unittest.TestCase):
    ...
    def test_for(self):
        self.assertEqual(cli.Config.from_function(func), cli.Config(b=2, c=[], d=None))
...
class TestCommands(unittest.TestCase):
    ...
    def test_cc(self, harv_mock, log_mock):
        ...
        log_mock.assert_called_once_with(
            mock.sentinel.harvester, codeclimate=False, json=True, xml=False
        )
    ...
    def test_raw(self, harv_mock, log_mock):
        ...
        harv_mock.assert_called_once_with(
            ["-"], cli.Config(exclude=None, ignore=None, summary=True)
        )
    ...
    def test_mi(self, harv_mock, log_mock):
        ...
        harv_mock.assert_called_once_with(
            ["-"],
            cli.Config(
                min="A", max="C", exclude=None, ignore=None, show=True, multi=False
            ),
        )
