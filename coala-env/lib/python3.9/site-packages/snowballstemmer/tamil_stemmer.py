...
class TamilStemmer(BaseStemmer):
    ...
    def __r_fix_va_start(self):
        ...
        if among_var == 1:
            if not self.slice_from("\u0B93"):
                return False
        elif among_var == 2:
            if not self.slice_from("\u0B92"):
                return False
        elif among_var == 3:
            if not self.slice_from("\u0B89"):
                return False
        else:
            if not self.slice_from("\u0B8A"):
                return False
        return True
        ...
        try:
            ...
            try:
                ...
                if among_var == 1:
                    ...
                    if not self.slice_from("\u0BB3\u0BCD"):
                        return False
                elif among_var == 4:
                    if not self.slice_from("\u0BB2\u0BCD"):
                        return False
                elif among_var == 5:
                    if not self.slice_from("\u0B9F\u0BC1"):
                        return False
                elif among_var == 6:
                    ...
                    try:
                        if not self.eq_s_b("\u0BC8"):
                            raise lab2()
                        raise lab1()
                    except lab2:
                        pass
                    self.cursor = self.limit - v_3
                    if not self.slice_from("\u0BAE\u0BCD"):
                        return False
                elif among_var == 7:
                    if not self.slice_from("\u0BCD"):
                        return False
                elif among_var == 8:
    ...
    a_2 = [Among("\u0BBF", -1, -1), Among("\u0BC0", -1, -1), Among("\u0BC8", -1, -1)]
    ...
    a_4 = [Among("", -1, 2), Among("\u0BC8", 0, 1), Among("\u0BCD", 0, 1)]
    ...
    a_10 = [Among("\u0B85", -1, -1), Among("\u0B87", -1, -1), Among("\u0B89", -1, -1)]
    ...
    a_14 = [Among("\u0BBE", -1, -1), Among("\u0BC7", -1, -1), Among("\u0BCB", -1, -1)]

    a_15 = [Among("\u0BAA\u0BBF", -1, -1), Among("\u0BB5\u0BBF", -1, -1)]
