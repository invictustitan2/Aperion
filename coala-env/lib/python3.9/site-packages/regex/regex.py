...
from regex._regex_core import (_check_group_features, _compile_firstset,
                               _compile_replacement, _FirstSetError,
                               _flatten_code, _fold_case, _get_required_string,
                               _parse_pattern, _shrink_cache, _UnscopedFlagSet)
