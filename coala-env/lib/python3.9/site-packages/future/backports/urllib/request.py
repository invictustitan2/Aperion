...
from .error import ContentTooShortError, HTTPError, URLError
from .parse import (
    quote,
    splitattr,
    splithost,
...
from .response import addclosehook, addinfourl
        ...
        if authreq:
            ...
            if scheme.lower() != "basic":
                raise ValueError(
                    ...
                    " support the following scheme: '%s'" % scheme
                )
            else:
                ...
                try:
                    ...
                    if isinstance(data, Iterable):
                        raise ValueError(
                            ...
                            "for iterable data of type %r %r" % (type(data), data)
                        )
                else:
                    request.add_unredirected_header("Content-length", "%d" % size)
    ...
    def _open_generic_http(self, connection_factory, url, data):
        ...
        if 200 <= response.status < 300:
            ...
            return self.http_error(
                url, response.fp, response.status, response.reason, response.msg, data
            )
