...
def jupyter_parser() -> JupyterParser:
    ...
    group.add_argument(
        "--config-dir", action="store_true", help="show Jupyter config dir"
    )
    group.add_argument("--data-dir", action="store_true", help="show Jupyter data dir")
    group.add_argument(
        "--runtime-dir", action="store_true", help="show Jupyter runtime dir"
    )
    group.add_argument(
        "--paths",
        action="store_true",
...
def _path_with_self() -> list[str]:
    ...
    for script in scripts:
        ...
        if Path(bindir).is_dir() and os.access(
            script, os.X_OK
