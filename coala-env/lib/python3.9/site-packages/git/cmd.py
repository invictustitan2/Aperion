...
from typing import (IO, TYPE_CHECKING, Any, AnyStr, BinaryIO, Callable, Dict,
                    Iterator, List, Mapping, Optional, Sequence, TextIO, Tuple,
                    Union, cast, overload)

from git.compat import defenc, force_bytes, safe_decode
from git.exc import (CommandError, GitCommandError, GitCommandNotFound,
                     UnsafeOptionError, UnsafeProtocolError)
from git.types import TBD, Literal, PathLike
from git.util import (cygpath, expand_path, is_cygwin_git, patch_env,
