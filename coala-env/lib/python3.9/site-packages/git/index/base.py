...
from typing import (IO, TYPE_CHECKING, Any, BinaryIO, Callable, Dict,
                    Generator, Iterable, Iterator, List, NoReturn, Sequence,
                    Tuple, Union)

import git.diff as git_diff
from git.compat import defenc, force_bytes
from git.exc import (CheckoutError, GitCommandError, GitError,
                     InvalidGitRepositoryError)
from git.objects import Blob, Commit, Object, Submodule, Tree
from git.objects.util import Serializable
from git.types import Literal, PathLike
from git.util import (Actor, LazyMixin, LockedFD, file_contents_ro,
                      join_path_native, to_bin_sha, to_native_path_linux,
                      unbare_repo)
from gitdb.base import IStream
from gitdb.db import MemoryDB

from .fun import (S_IFGITLINK, aggressive_tree_merge, entry_key, read_cache,
                  run_commit_hook, stat_mode_to_index_mode, write_cache,
                  write_tree_from_cache)
from .typ import BaseIndexEntry, IndexEntry, StageType
from .util import (TemporaryFileSwap, default_index, git_working_dir,
                   post_clear_cache)
