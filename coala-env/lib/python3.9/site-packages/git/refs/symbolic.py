...
import os
from typing import (TYPE_CHECKING, Any, Iterator, List, Tuple, Type, TypeVar,
                    Union, cast)
...
from git.util import (LockedFD, assure_directory_exists, hex_to_bin, join_path,
                      join_path_native, to_native_path_linux)
...
class SymbolicReference:
    ...
    def from_path(cls: Type[T_References], repo: "Repo", path: PathLike) -> T_References:
        ...
        from . import HEAD, Head, Reference, RemoteReference, TagReference
