...
from .data import BLOCK_RSHIFT, BLOCKS
...
try:
    ...
    def check_with_enchant(
        words, languages, threshold=0.7, min_words=1, dictionaries={}
    ):
...
def decode_text(text, encoding="utf-8"):
    ...
    if not isinstance(text, str):
        warnings.warn("passing an encoded string is deprecated", DeprecationWarning, 4)
