...
from dennis.translator import (AngleQuoteTransform, DoubleTransform,
                               DubstepTransform, EmptyTransform, HahaTransform,
                               HTMLExtractorTransform, PirateTransform,
                               RedactedTransform, ReverseTransform,
                               ShoutyTransform, Token, Translator,
                               XXXTransform, ZombieTransform)
