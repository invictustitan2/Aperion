...
class TestCheck(Check):
    ...
    def test_smoke_check_redundancy(self):
        ...
        """
        assert chk.check_redundancy("Basic smoke phrase without issues.") == []
        assert chk.check_redundancy("It happened at 7 a.m.") == []
        assert chk.check_redundancy("It happened at 7a.m. in the morning.") != []
