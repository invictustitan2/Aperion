...
class TestValidator(TestsBase):
    ...
    def test_nb4_document_info(self):
        ...
        with self.fopen("test4docinfo.ipynb", "r") as f:
            nb = read(f, as_version=4)
        validate(nb)
        self.assertEqual(isvalid(nb), True)
    ...
    def test_nb4custom(self):
        ...
        with self.fopen("test4custom.ipynb", "r") as f:
            nb = read(f, as_version=4)
        validate(nb)
        self.assertEqual(isvalid(nb), True)
    ...
    def test_nb4jupyter_metadata(self):
        ...
        with self.fopen("test4jupyter_metadata.ipynb", "r") as f:
            nb = read(f, as_version=4)
        validate(nb)
        self.assertEqual(isvalid(nb), True)
    ...
    def test_invalid(self):
        ...
        # - invalid cell type
        # - invalid output_type
        with self.fopen("invalid.ipynb", "r") as f:
            nb = read(f, as_version=4)
    ...
    def test_future(self):
        ...
        with self.fopen("test4plus.ipynb", "r") as f:
            nb = read(f, as_version=4)
        with self.assertRaises(ValidationError):
