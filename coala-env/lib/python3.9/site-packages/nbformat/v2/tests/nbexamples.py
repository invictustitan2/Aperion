...
ws.cells.append(
    new_text_cell("html", source="Some NumPy Examples", rendered="Some NumPy Examples")
)
...
ws.cells.append(
    new_text_cell("markdown", source="A random array", rendered="A random array")
)

ws.cells.append(
    new_code_cell(input="a = numpy.random.rand(100)", prompt_number=2, collapsed=True)
)
