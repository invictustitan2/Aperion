...
from yapf.yapflib import py3compat, style, yapf_api
...
class FormatFileTest(unittest.TestCase):
    ...
    def testFormatFile(self):
        ...
        expected_formatted_code_chromium = textwrap.dedent(
            """\
        if True:
          pass
        """
    ...
    def testFormatFileDiff(self):
        ...
        f = self._MakeTempFileWithContents("testfile1.py", unformatted_code)
        diff, _, _ = yapf_api.FormatFile(f, print_diff=True)
        self.assertTrue("+  pass" in diff)

    def testFormatFileInPlace(self):
        unformatted_code = "True==False\n"
        formatted_code = "True == False\n"
        f = self._MakeTempFileWithContents("testfile1.py", unformatted_code)
        result, _, _ = yapf_api.FormatFile(f, in_place=True)
        self.assertEqual(result, None)
        with open(f) as fd:
            self.assertCodeEqual(formatted_code, fd.read())

        self.assertRaises(
            ValueError, yapf_api.FormatFile, f, in_place=True, print_diff=True
        )
    ...
    def testNoFile(self):
        ...
        self.assertEqual(
            stream.getvalue(), "[Errno 2] No such file or directory: 'not_a_file.py'\n"
        )
...
class CommandLineTest(unittest.TestCase):
    ...
    def testUnicodeEncodingPipedToFile(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".py", dir=self.test_tmpdir) as outfile:
            with tempfile.NamedTemporaryFile(
                suffix=".py", dir=self.test_tmpdir
            ) as testfile:
    ...
    def testInPlaceReformattingEmpty(self):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            with py3compat.open_with_encoding(
                testfile.name, mode="r", encoding="utf-8"
            ) as fd:
                reformatted_code = fd.read()
    ...
    def testReformattingSpecificLines(self):
        ...
        # line" with flake8.
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--lines", "1-2"]
        )
    ...
    def testOmitFormattingLinesBeforeDisabledFunctionComment(self):
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--lines", "5-5"]
        )
    ...
    def testRetainingSemicolonsWhenSpecifyingLines(self):
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--lines", "1-1"]
        )
    ...
    def testDisableWhenSpecifyingLines(self):
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--lines", "1-10"]
        )
    ...
    def testRetainVerticalFormattingBetweenDisabledAndEnabledLines(self):
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--lines", "4-7"]
        )
    ...
    def testFormatLinesSpecifiedInMiddleOfExpression(self):
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--lines", "5-6"]
        )
    ...
    """
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--style=pep8"]
        )
