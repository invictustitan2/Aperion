...
from yapf.yapflib import format_decision_state, pytree_utils, style, unwrapped_line
...
def _FilterLine(uwline):
    ...
    return [
        ft for ft in uwline.tokens if ft.name not in pytree_utils.NONSEMANTIC_TOKENS
    ]
