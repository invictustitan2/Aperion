...
from pygments.lexers._lilypond_builtins import (articulations, chord_modifiers,
                                                clefs, context_properties,
                                                contexts, dynamics,
                                                grob_properties, grobs,
                                                header_variables, keywords,
                                                markup_commands,
                                                music_commands,
                                                music_functions,
                                                paper_variables,
                                                pitch_language_names, pitches,
                                                repeat_types, scales,
                                                scheme_functions, translators,
                                                units)
