...
class TestRestructuredtextLint(TestCase):
    ...
    def test_raises_on_invalid_rst(self):
        ...
        expected_yaml = self._load_file(
            os.path.join(__dir__, "test_files", "invalid.yaml")
        )
...
class TestRestructuredtextLintCLI(TestCase):
    ...
    def test_rst_lint_filepaths_not_given(self):
        ...
        with self.assertRaises(subprocess.CalledProcessError):
            ...
            output = subprocess.check_output(
                (sys.executable, rst_lint_path), stderr=subprocess.STDOUT
            )
    ...
    def test_rst_lint_many_files(self):
        ...
        with self.assertRaises(subprocess.CalledProcessError) as e:
            ...
            subprocess.check_output(
                (sys.executable, rst_lint_path, valid_rst, invalid_rst)
            )
    ...
    def test_level_fail(self):
        ...
        with self.assertRaises(subprocess.CalledProcessError) as e:
            subprocess.check_output(
                (sys.executable, rst_lint_path, "--level", "warning", warning_rst),
    ...
    def test_level_high(self):
        ...
        # Return code 0
        output = subprocess.check_output(
            (sys.executable, rst_lint_path, "--level", "error", warning_rst),
            universal_newlines=True,
        )
