...
class ResultAction:
    ...
    @enforce_signature
    def apply_from_section(
        self, result, original_file_dict: dict, file_diff_dict: dict, section: Section
    ):
        """
    ...
    def get_metadata(cls):
        ...
        data = FunctionMetadata.from_function(
            cls.apply, omit={"self", "result", "original_file_dict", "file_diff_dict"}
        )
