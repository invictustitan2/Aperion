...
@generate_repr()
@generate_eq("documentation", "language", "docstyle", "indent", "marker", "range")
class DocumentationComment:
    ...
    def __init__(self, documentation, docstyle_definition, indent, marker, range):
        """
    ...
    def parse(self):
        ...
        if self.language == "python" and self.docstyle == "default":
            return self._parse_documentation_with_symbols((":param ", ":"), ":return:")
    ...
    def _parse_documentation_with_symbols(self, param_identifiers, return_identifiers):
        """
        ...
        for line in lines:
            ...
            if stripped_line.startswith(param_identifiers[0]):
                ...
                param_offset = line.find(param_identifiers[0]) + len(
                    param_identifiers[0]
                )
    ...
    @classmethod
    def from_metadata(cls, doccomment, docstyle_definition, marker, indent, range):
        r"""
        ...
        for section in doccomment:
            ...
            if isinstance(section, cls.Parameter):
                assembled_doc += (
                    docstyle_definition.metadata.param_start
                    + section.name
        ...
        return DocumentationComment(
            assembled_doc, docstyle_definition, indent, marker, range
        )
    ...
    def assemble(self):
        ...
        return (
            assembled + (self.indent if lines[-1][-1] == "\n" else "") + self.marker[2]
        )
