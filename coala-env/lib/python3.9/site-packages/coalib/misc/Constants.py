...
CRASH_MESSAGE = (
    "An unknown error occurred. This is a bug. We are "
...
VERSION_CONFLICT_MESSAGE = (
    "There is a conflict in the version of a "
...
coalib_root = os.path.join(os.path.dirname(__file__), os.path.pardir)

# Path to the language definition files
language_definitions = os.path.join(coalib_root, "bearlib", "languages", "definitions")
    ...
    logging.config.dictConfig(
        {
            ...
            "root": {"level": "DEBUG", "handlers": ["colored"]},
            "formatters": {
                "colored": {
