...
from mypy.nodes import Expression, Key, Node, RefExpr, SymbolTableNode, Var
from mypy.sametypes import is_same_type
from mypy.subtypes import is_subtype
from mypy.types import AnyType, PartialType, Type
...
class ConditionalTypeBinder:
    ...
    def assign_type(
        ...
        if (
            isinstance(self.most_recent_enclosing_type(expr, type), AnyType)
