...
from mypy.nodes import (AssignmentStmt, CallExpr, ComparisonExpr, Expression,
                        FuncDef, IndexExpr, MemberExpr, MypyFile, NameExpr,
                        OpExpr, RefExpr, TypeApplication, UnaryExpr,
                        YieldFromExpr)
from mypy.traverser import TraverserVisitor
from mypy.types import (ANY_TYPE_STRATEGY, AnyType, CallableType, FunctionLike,
                        Instance, TupleType, Type, TypeQuery, TypeVarType,
                        Void)
