...
from mypy.fastparse import TypeCommentParseError, TypeConverter
...
try:
    from typed_ast import ast27, ast35
except ImportError:
...
class ASTConverter(ast27.NodeTransformer):
    ...
    def visit_Assign(self, n: ast27.Assign) -> AssignmentStmt:
        ...
        return AssignmentStmt(
            self.translate_expr_list(n.targets), self.visit(n.value), type=typ
        )
    ...
    def visit_Print(self, n: ast27.Print) -> ExpressionStmt:
        ...
        if not n.nl:
            keywords.append(
                ast27.keyword("end", ast27.Str(" ", lineno=n.lineno, col_offset=-1))
            )
    ...
    def visit_Attribute(self, n: ast27.Attribute) -> Expression:
        if (
            isinstance(n.value, ast27.Call)
            and isinstance(n.value.func, ast27.Name)
