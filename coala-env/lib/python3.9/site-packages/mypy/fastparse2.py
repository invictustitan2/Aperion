...
from mypy.nodes import (ARG_NAMED, ARG_OPT, ARG_POS, ARG_STAR, ARG_STAR2,
                        Argument, AssertStmt, AssignmentStmt, Block, BreakStmt,
                        BytesExpr, CallExpr, ClassDef, ComparisonExpr,
                        ComplexExpr, ConditionalExpr, ContinueStmt, Decorator,
                        DelStmt, DictExpr, DictionaryComprehension,
                        EllipsisExpr, Expression, ExpressionStmt, FloatExpr,
                        ForStmt, FuncDef, FuncExpr, GeneratorExpr, GlobalDecl,
                        ...
                        PassStmt, RaiseStmt, ReturnStmt, SetComprehension,
                        SetExpr, SliceExpr, Statement, StrExpr, SuperExpr,
