...
from dennis.minisix import HTMLParseError, izip_longest
        ...
        for trstr in linted_entry.strs:
            ...
            msgs.append(
                LintMessage(
                    ...
                    0,
                    self.num,
                    "type missing: {0}".format(", ".join(malformed)),
        ...
        for trstr in linted_entry.strs:
            ...
            msgs.append(
                LintMessage(
                    ...
                    0,
                    self.num,
                    "missing right curly-brace: {0}".format(", ".join(malformed)),
                    linted_entry.poentry,
                )
            )
        ...
        for trstr in linted_entry.strs:
            ...
            msgs.append(
                LintMessage(
                    ...
                    0,
                    self.num,
                    "missing left curly-brace: {0}".format(", ".join(malformed)),
                    linted_entry.poentry,
                )
            )
        return msgs
                ...
                if len(match) == 1 or match[1] not in "(diouxefGgcrs%":
                    msgs.append(
                        LintMessage(
                            ...
                            0,
                            self.num,
                            "bad format character: {0}".format(match),
                            linted_entry.poentry,
                        )
                    )
        return msgs
                ...
                if vartok.contains("python-format") and len(
                    ...
                    msgs.append(
                        LintMessage(
                            ...
                            0,
                            self.num_error,
                            "missing variables: {0}".format(", ".join(sorted(missing))),
                            linted_entry.poentry,
                        )
                    )
                else:
    ...
    def lint(self, vartok, linted_entry):
        ...
        for trstr in linted_entry.strs:
            ...
            try:
                ...
                errmsg = "invalid html: msgid has invalid html {0}".format(exc)
                msgs.append(
                    LintMessage(
                        WARNING,
                        linted_entry.poentry.linenum,
            ...
            if len(trstr.msgid_strings) > 1:
                ...
                try:
                    ...
                    errmsg = "invalid html: msgid_plural has invalid html {0}".format(
                        exc
                    )
            ...
            try:
                ...
                errmsg = "invalid html: msgstr has invalid html {0}".format(exc)
                msgs.append(
                    LintMessage(
                        WARNING,
                        linted_entry.poentry.linenum,
            ...
            for left, right in izip_longest(msgid_parts, msgstr_parts, fillvalue=None):
                if not left or not right or not equiv(left, right):
                    msgs.append(
                        LintMessage(
                            WARNING,
            ...
            if invalid:
                msgs.append(
                    LintMessage(
                        ...
                        0,
                        self.num,
                        "invalid variables: {0}".format(", ".join(sorted(invalid))),
                        linted_entry.poentry,
                    )
                )
        return msgs
