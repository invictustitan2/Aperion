...
@linter(executable="eslint", use_stdin=True, use_stderr=True)
class ESLintBear:
    """
    ...
    def process_output(self, output, filename, file):
        if output[1]:
            self.warn(
                "While running {0}, some issues were found:".format(
