...
from coalib.bears.requirements.DistributionRequirement import DistributionRequirement
...
class PHPCodeSnifferBear:
    ...
    LICENSE = "AGPL-3.0"
    CAN_DETECT = {"Formatting", "Syntax", "Documentation", "Code Simplification"}
    ...
    def generate_config(
        ...
        """
        rules_map = {
            "Generic.WhiteSpace.DisallowTabIndent": use_spaces,
            "Generic.Formatting.DisallowMultipleStatements": not allow_multiple_statements_per_line,
            "Generic.PHP.LowerCaseKeyword": force_lower_case_keywords,
            "Generic.PHP.LowerCaseConstant": force_lower_case_constants,
            "PSR2.Namespaces.UseDeclaration": check_use_blocks,
            "PSR2.Namespaces.NamespaceDeclaration": blank_line_after_namespace_declaration,
            "PSR2.Classes.ClassDeclaration": check_class_declaration,
            "PSR2.Classes.PropertyDeclaration": check_property_declaration,
            "Squiz.Scope.MethodScope": force_scope_modifier_on_method,
            "Squiz.Functions.MultiLineFunctionDeclaration": allow_multiline_function_declaration,
        }
        rules = ""
