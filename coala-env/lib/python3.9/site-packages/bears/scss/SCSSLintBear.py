...
@linter(
    ...
    output_format="regex",
    output_regex=r".+:(?P<line>\d+)\s+(\[(?P<severity>.)\])\s*" r"(?P<message>.*)",
)
class SCSSLintBear:
    """
    ...
    def generate_config(
        ...
        options = {
            ...
            "HexLength": {
                "enabled": True,
                "style": ("short" if use_short_hexadecimal_length_style else "long"),
            },
            "HexNotation": {
                "enabled": True,
                "style": ("lowercase" if use_lowercase_hexadecimal else "uppercase"),
            },
            "HexValidation": {"enabled": validate_hexadecimal},
            "IdSelector": {"enabled": not allow_id_selector},
            "ImportantRule": {"enabled": not allow_important_rule_in_properties},
            "Indentation": {
                "enabled": True,
            ...
            "LeadingZero": {
                "enabled": True,
                "style": ("exclude_zero" if exclude_leading_zero else "include_zero"),
            },
            "MergeableSelector": {
            ...
            "NameFormat": {
                ...
                "function_convention": naming_convention_map.get(
                ...
                "variable_convention": naming_convention_map.get(
                    variable_naming_convention, variable_naming_convention
                ),
                "placeholder_convention": naming_convention_map.get(
                    placeholder_naming_convention, placeholder_naming_convention
                ),
            },
            "PlaceholderInExtend": {"enabled": use_placeholder_selector_in_extend},
            "PropertyCount": {
                "enabled": False,
            ...
            "UnnecessaryMantissa": {"enabled": not allow_unnecessary_mantissa},
            "UnnecessaryParentReference": {
                "enabled": not allow_unnecesseary_parent_reference
            },
            "TrailingSemicolon": {"enabled": allow_trailing_semicolon},
            "TrailingWhitespace": {"enabled": not allow_trailing_whitespaces},
            "ImportPath": {
            ...
            "SpaceAroundOperator": {
                "enabled": True,
                "style": space_setting_map.get(
                    spaces_around_operators, "at_least_one_space"
                ),
            },
        }
