...
@linter(executable="xmllint", use_stdout=True, use_stderr=True)
class XMLBear:
    """
    ...
    def create_arguments(
        filename, file, config_file, xml_schema: path = "", xml_dtd: path_or_url = ""
    ):
        """
        ...
        if output[0]:
            ...
            return itertools.chain(
                self.process_output_regex(
                    output[1], filename, file, output_regex=self._output_regex
                ),
