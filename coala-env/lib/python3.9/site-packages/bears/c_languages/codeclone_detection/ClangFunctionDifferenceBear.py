...
from bears.c_languages.codeclone_detection.ClangCountingConditions import condition_dict
...
class ClangFunctionDifferenceBear(GlobalBear):
    ...
    def run(
        ...
        count_matrices = get_count_matrices(
            ClangCountVectorCreator(
                list(counting_conditions.keys()), list(counting_conditions.values())
            ),
