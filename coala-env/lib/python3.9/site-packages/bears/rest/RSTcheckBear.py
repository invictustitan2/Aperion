...
@linter(
    ...
    use_stderr=True,
    output_format="regex",
    output_regex=r".+\s?:(?P<line>\d+):\s" r"(?P<message>\((?P<severity>\w+).+)",
    severity_map={
...
class RSTcheckBear:
    ...
    def create_arguments(
        filename, file, config_file, code_block_language_ignore: list = ()
    ):
        """
        ...
        if code_block_language_ignore:
            args = ("--ignore-language=" + ",".join(code_block_language_ignore),)
