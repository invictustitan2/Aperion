...
class LanguageToolBear(LocalBear):
    ...
    def run(
        ...
        language = guess_language(joined_text) if language == "auto" else language
        ...
        for match in matches:
            ...
            source_range = SourceRange.from_values(
                filename, match.fromy + 1, match.fromx + 1, match.toy + 1, match.tox + 1
            )
            yield Result(self, message, diffs=diffs, affected_code=(source_range,))
