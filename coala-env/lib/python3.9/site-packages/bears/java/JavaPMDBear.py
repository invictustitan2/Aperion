...
@linter("bash", output_format="regex", output_regex=r".+:(?P<line>.+):(?P<message>.*)")
class JavaPMDBear:
    """
    ...
    LICENSE = "AGPL-3.0"
    CAN_DETECT = {"Code Simplification", "Unreachable Code", "Smell", "Duplication"}
    ...
    @staticmethod
    @deprecate_settings(
        allow_unnecessary_code=("check_unnecessary", negate),
