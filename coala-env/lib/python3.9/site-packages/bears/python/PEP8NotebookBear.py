...
def autopep8_fix_code_cell(source, options=None, apply_config=None):
    ...
    """
    source_corrected = autopep8.fix_code(
        source, apply_config=apply_config, options=options
    )
    ...
    def run(
        ...
        for cell in cells:
            if cell["cell_type"] != "code":
                continue
            cell["source"] = autopep8_fix_code_cell(
                cell["source"], local_pep8_config, options
            )
