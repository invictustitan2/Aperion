...
@linter(executable="rubocop", use_stdin=True)
class RuboCopBear:
    """
    ...
    LANGUAGES = {"Ruby"}
    REQUIREMENTS = {GemRequirement("rubocop"), PipRequirement("pyyaml", "3.12")}
    ...
    def generate_config(
        ...
        comment_keywords: tuple = ("TODO", "FIXME", "OPTIMIZE", "HACK", "REVIEW"),
        ...
        options = {
            ...
            "Style/Alias": {"EnforcedStyle": preferred_alias},
            "Style/AlignHash": {
            ...
            "Style/AlignParameters": {"EnforcedStyle": align_parameters},
            "Style/ClassCheck": {"EnforcedStyle": class_check},
            "Style/CommentAnnotation": {"Keywords": comment_keywords},
            "Style/GuardClause": {"MinBodyLength": min_if_unless_guard},
            "Style/IndentationWidth": {"Width": indent_size},
            "Style/MethodName": {
                "EnforcedStyle": naming_convention.get(
                    method_naming_convention, method_naming_convention
                )
            },
            "Style/StringLiterals": {"EnforcedStyle": string_literals},
            "Style/VariableName": {
                "EnforcedStyle": naming_convention.get(
            ...
            "Metrics/CyclomaticComplexity": {"Max": cyclomatic_complexity},
            "Metrics/LineLength": {
                "Max": max_line_length,
            ...
            "Lint/UnusedBlockArgument": {
                ...
                "AllowUnusedKeywordArguments": allow_unused_block_keyword_arguments,
            },
            "Lint/UnusedMethodArgument": {
                "AllowUnusedKeywordArguments": allow_unused_method_keyword_args,
        ...
        for result in output["files"][0]["offenses"]:
            ...
            yield Result.from_values(
                origin="{class_name} ({rule})".format(
                    class_name=self.__class__.__name__, rule=result["cop_name"]
                ),
                ...
                end_column=result["location"]["column"] + result["location"]["length"],
            )
