...
def _detect_identifier_scope_visibility(id_node, context_scope):
    ...
    is_implicit = (
        get_explicity_of_scope_visibility(id_node)
    ...
    if is_builtin_variable(id_node):
        return _create_identifier_visibility_hint(
            ScopeVisibility.BUILTIN, is_implicit=is_implicit
        )
    ...
    if is_function_identifier(id_node):
        ...
        return _create_identifier_visibility_hint(
            ScopeVisibility.GLOBAL_LIKE, is_implicit=is_implicit
        )
    ...
    return _create_identifier_visibility_hint(
        ScopeVisibility.FUNCTION_LOCAL, is_implicit=is_implicit
    )
