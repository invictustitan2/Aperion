...
class IdentifierClassifier(object):
    ...
    class IdentifierCollector(object):
        ...
        def _enter_handler(self, node):
            ...
            if (
                id_attr[IDENTIFIER_ATTRIBUTE_DYNAMIC_FLAG]
                or id_attr[IDENTIFIER_ATTRIBUTE_MEMBER_FLAG]
            ):
                return
    ...
    def attach_identifier_attributes(self, ast):
        ...
        ast_with_parse_map_and_filter_and_redir = map_and_filter_parser.process(
            ast_with_parsed_redir
        )

        traverse(ast_with_parse_map_and_filter_and_redir, on_enter=self._enter_handler)
        return ast

    def _set_identifier_attribute(
        self,
        node,
        is_declarative=None,
        is_dynamic=None,
    ...
    def _pre_mark_member_node(self, member_node):
        ...
        if (
            member_node_type in IdentifierTerminateNodeTypes
            or member_node_type in AnalyzableSubScriptChildNodeTypes
        ):
            self._set_identifier_attribute(member_node, is_member=True)

    def _enter_identifier_like_node(
        self,
        node,
        is_declarative=None,
        is_function=None,
    ...
    def _enter_function_node(self, func_node):
        ...
        self._enter_identifier_like_node(
            func_name_node, is_declarative=True, is_function=True
        )
        ...
        for func_param_node in func_param_nodes:
            self._enter_identifier_like_node(
                func_param_node, is_declarative_parameter=True, is_declarative=True
            )

    def _enter_delfunction_node(self, delfunc_node):
        func_name_node = delfunc_node["left"]
        self._enter_identifier_like_node(func_name_node, is_function=True)

    def _enter_curlyname_node(
        self,
        curlyname_node,
        is_declarative=None,
        is_function=None,
        ...
        self._set_identifier_attribute(
            curlyname_node,
            is_dynamic=True,
            is_declarative=is_declarative,
            is_function=is_function,
