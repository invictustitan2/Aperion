...
from vint.ast.plugin.scope_plugin import ExplicityOfScopeVisibility, ScopeVisibility
...
class ProhibitImplicitScopeBuiltinVariable(AbstractPolicy):
    ...
    def is_valid(self, identifier, lint_context):
        ...
        objective_scope_visibility = scope_plugin.get_objective_scope_visibility(
            identifier
        )

        is_valid = not (
            explicity is ExplicityOfScopeVisibility.IMPLICIT
