...
class Linter(object):
    ...
    def __init__(self, policy_set, config_dict_global):
        ...
        self._config = self._decorate_config(
            config_dict_global, self._config_comment_source
        )
    ...
    def build_parser(self):
        ...
        enable_neovim = get_config_value(
            config_dict, ["cmdargs", "env", "neovim"], False
        )
    ...
    def _decorate_config(self, config_dict_global, config_comment_source):
        ...
        config_container = ConfigContainer(config_dict_source, config_comment_source)

        return config_container

    def _parse_vimlparser_error(self, err_message):
        match = re.match(
            r"vimlparser: (?P<description>.*): line (?P<line_number>\d+) col (?P<column_number>\d+)$",
            err_message,
        )
