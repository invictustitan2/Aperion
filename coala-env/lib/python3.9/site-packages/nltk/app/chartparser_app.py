...
import os.path
import pickle
from tkinter import (Button, Canvas, Checkbutton, Frame, IntVar, Label, Menu,
...
from nltk.draw.util import (CanvasFrame, ColorizedList, EntryDialog,
                            MutableOptionMenu, ShowText, SymbolWidget)
from nltk.grammar import CFG, Nonterminal
from nltk.parse.chart import (BottomUpPredictCombineRule, BottomUpPredictRule,
                              Chart, LeafEdge, LeafInitRule,
                              SingleEdgeFundamentalRule, SteppingChartParser,
                              TopDownInitRule, TopDownPredictRule, TreeEdge)
