...
import re
import threading
from tkinter import (END, LEFT, SUNKEN, Button, Entry, Frame, IntVar, Label,
                     Menu, OptionMenu, Scrollbar, StringVar, Text, Tk)
from tkinter.font import Font

from nltk.corpus import (alpino, brown, cess_cat, cess_esp, floresta, indian,
                         mac_morpho, nps_chat, sinica_treebank, treebank)
