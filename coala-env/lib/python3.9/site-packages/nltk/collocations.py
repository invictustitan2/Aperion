...
from nltk.metrics import (BigramAssocMeasures, ContingencyMeasures,
                          QuadgramAssocMeasures, TrigramAssocMeasures)
...
def demo(scorer=None, compare_scorer=None):
    ...
    from nltk.metrics import (BigramAssocMeasures, ranks_from_scores,
