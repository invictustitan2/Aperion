...
def errors_to_json(errors):
    ...
    return json.dumps(dict(status="success", data={"errors": out}), sort_keys=True)
...
def preferred_forms_check(
    text, list, err, msg, ignore_case=True, offset=0, max_errors=float("inf")
):
