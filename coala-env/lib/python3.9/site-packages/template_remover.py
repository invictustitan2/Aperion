...
JINJA_PATTERN = get_pattern(
    [JINJA_START_ECHO], [JINJA_START_TAG], [JINJA_END_TAG, JINJA_END_ECHO]
)
...
MAKO_PATTERN = get_pattern(
    [MAKO_START_ECHO], [MAKO_START_TAG], [MAKO_END_TAG, MAKO_END_ECHO]
)

ALL_PATTERN = get_pattern(
    [
        PHP_START_ECHO,
        PHP_START_TAG_WITH_ECHO,
        PHP_START_TAG_SHORT_WITH_ECHO,
        JINJA_START_ECHO,
        MAKO_START_ECHO,
    ],
...
def _get_tag(match):
    ...
    print(groups)
    assert False, (
        'Only the groups "echo", "end", "start", "newline" and '
