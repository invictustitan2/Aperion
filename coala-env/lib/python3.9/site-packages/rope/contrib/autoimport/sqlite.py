...
from typing import (TYPE_CHECKING, Generator, Iterable, Iterator, List,
                    Optional, Set, Tuple)
...
from rope.contrib.autoimport.defs import (Alias, ModuleFile, Name, NameType,
                                          Package, PackageType, SearchResult,
                                          Source)
