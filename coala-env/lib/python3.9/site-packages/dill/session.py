...
from dill import Pickler, Unpickler, _dill

from ._dill import (BuiltinMethodType, FunctionType, MethodType, ModuleType,
                    TypeType, UnpicklingError, __builtin__, _import_module,
                    _is_builtin_module, _is_imported_module, _main_module,
                    _reverse_typemap)
