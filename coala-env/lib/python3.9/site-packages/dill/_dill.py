...
from types import (BuiltinMethodType, CodeType, FrameType, FunctionType,
                   GeneratorType, MethodType, ModuleType, TracebackType)
...
from types import MethodWrapperType  # XXX: unused
from types import (ClassMethodDescriptorType, GetSetDescriptorType,
...
from . import _shims
from ._shims import Getattr, Reduce
