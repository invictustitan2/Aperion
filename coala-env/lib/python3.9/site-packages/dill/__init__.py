...
try: # the package is installed
    ...
    from version import (__author__, __version__, get_license_text,
                         get_readme_as_rst)
...
from ._dill import (CONTENTS_FMODE, DEFAULT_PROTOCOL, FILE_FMODE, HANDLE_FMODE,
                    HIGHEST_PROTOCOL, PickleError, Pickler, PickleWarning,
                    PicklingError, PicklingWarning, Unpickler, UnpicklingError,
                    UnpicklingWarning, check, copy, dump, dumps, load, loads,
                    pickle, pickles, register)
from .session import (dump_module, dump_session,  # backward compatibility
                      load_module, load_module_asdict, load_session)
# get global settings
...
def extend(use_dill=True):
    ...
    Returns:
        None
    '''
    from ._dill import _extend, _revert_extension
    if use_dill: _extend()
