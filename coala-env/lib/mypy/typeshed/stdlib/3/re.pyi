...
@overload
def search(
    pattern: Pattern[AnyStr], string: AnyStr, flags: int = ...
) -> Match[AnyStr]: ...
@overload
...
@overload
def fullmatch(
    pattern: AnyStr, string: AnyStr, flags: int = ...
...
@overload
def split(
    pattern: AnyStr, string: AnyStr, maxsplit: int = ..., flags: int = ...
) -> List[AnyStr]: ...
@overload
def split(
    pattern: Pattern[AnyStr], string: AnyStr, maxsplit: int = ..., flags: int = ...
) -> List[AnyStr]: ...
@overload
...
@overload
def sub(
    pattern: AnyStr, repl: AnyStr, string: AnyStr, count: int = ..., flags: int = ...
) -> AnyStr: ...
@overload
def sub(
    pattern: AnyStr,
