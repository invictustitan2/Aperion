...
class TestCase:
    ...
    def assertIsNot(self, first: Any, second: Any, msg: Any = ...) -> None: ...
    def assertIsNone(self, expr: Any, msg: Any = ...) -> None: ...
    def assertIsNotNone(self, expr: Any, msg: Any = ...) -> None: ...
    def assertIn(self, first: _T, second: Iterable[_T], msg: Any = ...) -> None: ...
    def assertNotIn(self, first: _T, second: Iterable[_T], msg: Any = ...) -> None: ...
    def assertIsInstance(
        self, obj: Any, cls: Union[Type[Any], Tuple[Type[Any], ...]], msg: Any = ...
    ) -> None: ...
    def assertNotIsInstance(
        self, obj: Any, cls: Union[Type[Any], Tuple[Type[Any], ...]], msg: Any = ...
    ) -> None: ...
    def assertGreater(self, first: Any, second: Any, msg: Any = ...) -> None: ...
    def assertGreaterEqual(self, first: Any, second: Any, msg: Any = ...) -> None: ...
    def assertLess(self, first: Any, second: Any, msg: Any = ...) -> None: ...
    def assertLessEqual(self, first: Any, second: Any, msg: Any = ...) -> None: ...
    @overload
    def assertRaises(
        self,  # type: ignore
    ...
    @overload
    def assertWarns(
        self, exception: Union[Type[Warning], Tuple[Type[Warning], ...]], msg: Any = ...
    ) -> _AssertWarnsContext: ...
    @overload
    ...
    def assertRegex(
        self, text: str, regex: Union[str, Pattern[str]], msg: Any = ...
    ) -> None: ...
    def assertNotRegex(
        self, text: str, regex: Union[str, Pattern[str]], msg: Any = ...
    ) -> None: ...
    def assertCountEqual(
        self, first: Sequence[Any], second: Sequence[Any], msg: Any = ...
    ) -> None: ...
    ...
    def assertListEqual(
        self, first: List[Any], second: List[Any], msg: Any = ...
    ) -> None: ...
    def assertTupleEqual(
        self, first: Tuple[Any, ...], second: Tuple[Any, ...], msg: Any = ...
    ) -> None: ...
    def assertSetEqual(
        self, first: Set[Any], second: Set[Any], msg: Any = ...
    ) -> None: ...
    def assertDictEqual(
        self, first: Dict[Any, Any], second: Dict[Any, Any], msg: Any = ...
    ) -> None: ...
...
class TestLoader:
    ...
    if sys.version_info >= (3, 5):
        ...
        def loadTestsFromModule(self, module: ModuleType) -> TestSuite: ...
...
class TestResult:
    ...
    if sys.version_info >= (3, 4):
        def addSubTest(
            self, test: TestCase, subtest: TestCase, outcome: Optional[_SysExcInfoType]
        ) -> None: ...
