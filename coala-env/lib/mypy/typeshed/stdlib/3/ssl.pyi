...
if sys.version_info >= (3, 4):
    _PurposeType = NamedTuple(
        "_PurposeType",
        [("nid", int), ("shortname", str), ("longname", str), ("oid", str)],
    )
...
class SSLContext:
    ...
    def load_cert_chain(
        self, certfile: str, keyfile: Optional[str] = ..., password: _PasswordType = ...
    ) -> None: ...
    if sys.version_info >= (3, 4):
        ...
        def load_verify_locations(
            self, cafile: Optional[str] = ..., capath: Optional[str] = ...
        ) -> None: ...
