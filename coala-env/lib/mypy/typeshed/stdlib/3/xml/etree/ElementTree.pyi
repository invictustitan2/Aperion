...
class _ElementInterface(Sequence["_ElementInterface"]):
    ...
    def __init__(
        self,
        tag: Union[AnyStr, Callable[..., "_ElementInterface"]],
    ...
    def __setslice__(
        self, start: int, stop: int, elements: Sequence["_ElementInterface"]
    ) -> None: ...
...
class ElementTree:
    def __init__(
        self, element: _ElementInterface = ..., file: _file_or_filename = ...
    ) -> None: ...
    def getroot(self) -> _ElementInterface: ...
    def parse(
        self, source: _file_or_filename, parser: "XMLTreeBuilder" = ...
    ) -> _ElementInterface: ...
...
class TreeBuilder:
    def __init__(
        ...
        element_factory: Callable[
            [AnyStr, Dict[AnyStr, AnyStr]], _ElementInterface
        ] = ...,
    ) -> None: ...
