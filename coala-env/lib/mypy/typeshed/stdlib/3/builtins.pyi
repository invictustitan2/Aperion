...
class int(SupportsInt, SupportsFloat, SupportsAbs[int]):
    def __init__(
        self, x: Union[SupportsInt, str, bytes] = ..., base: int = ...
    ) -> None: ...
    def bit_length(self) -> int: ...
    def to_bytes(self, length: int, byteorder: str, *, signed: bool = ...) -> bytes: ...
    @classmethod
    def from_bytes(
        cls, bytes: Sequence[int], byteorder: str, *, signed: bool = ...
...
class str(Sequence[str]):
    ...
    @overload
    def __init__(
        self, o: bytes, encoding: str = ..., errors: str = "strict"
    ) -> None: ...
    ...
    def endswith(
        self, suffix: Union[str, Tuple[str, ...]], start: int = None, end: int = None
    ) -> bool: ...
    ...
    def startswith(
        self, prefix: Union[str, Tuple[str, ...]], start: int = None, end: int = None
    ) -> bool: ...
...
def eval(
    source: str, globals: Dict[str, Any] = None, locals: Mapping[str, Any] = None
) -> Any: ...  # TODO code object as source
def exec(
    object: str, globals: Dict[str, Any] = None, locals: Mapping[str, Any] = None
) -> Any: ...  # TODO code object as source
...
) -> Iterator[_S]: ...  # TODO more than two iterables
@overload
def max(arg1: _T, arg2: _T, *args: _T, key: Callable[[_T], Any] = ...) -> _T: ...
@overload
def max(
    iterable: Iterable[_T], key: Callable[[_T], Any] = ..., default: _T = ...
) -> _T: ...
@overload
...
def sorted(
    iterable: Iterable[_T], *, key: Callable[[_T], Any] = None, reverse: bool = False
) -> List[_T]: ...
...
def zip(
    ...
    iter3: Iterable[_T3],
    iter4: Iterable[_T4],
) -> Iterator[Tuple[_T1, _T2, _T3, _T4]]: ...  # TODO more than four iterables
def __import__(
    name: str,
