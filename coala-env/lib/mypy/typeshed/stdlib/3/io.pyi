...
from typing import IO, Any, BinaryIO, Callable, Iterator, List, Optional, TextIO, Union
...
class FileIO(RawIOBase):
    ...
    if sys.version_info >= (3, 3):
        ...
        def __init__(
            self, name: Union[str, bytes, int], mode: str = ..., closefd: bool = ...
        ) -> None: ...
...
class BytesIO(BinaryIO):
    ...
    def __exit__(
        self, t: type = None, value: BaseException = None, traceback: Any = None
    ) -> bool: ...
    def close(self) -> None: ...
    def fileno(self) -> int: ...
    def flush(self) -> None: ...
