...
from typing import AnyStr, Dict, Generic, List, Mapping, Sequence, Tuple, overload
...
@overload
def quote(
    string: str, safe: AnyStr = ..., encoding: str = ..., errors: str = ...
) -> str: ...
@overload
...
@overload
def urlencode(
    query: Sequence[Tuple[AnyStr, AnyStr]],
    doseq: bool = ...,
    safe: AnyStr = ...,
    encoding: str = ...,
    errors: str = ...,
...
@overload
def urlparse(
    url: str, scheme: str = ..., allow_framgents: bool = ...
) -> ParseResult: ...
@overload
def urlparse(
    url: bytes, scheme: bytes = ..., allow_framgents: bool = ...
) -> ParseResultBytes: ...
@overload
def urlsplit(
