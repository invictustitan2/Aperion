...
from typing import BinaryIO, Callable, Iterable, Iterator, List, Tuple, Union
...
_stream_reader_type = Callable[
    [BinaryIO], "StreamReader"
]  # signature of StreamReader __init__
_stream_writer_type = Callable[
    [BinaryIO], "StreamWriter"
]  # signature of StreamWriter __init__
_incremental_encoder_type = Callable[
    [], "IncrementalEncoder"
]  # signature of IncrementalEncoder __init__
_incremental_decode_type = Callable[
    [], "IncrementalDecoder"
]  # signature of IncrementalDecoder __init__
...
class CodecInfo(
    Tuple[_encode_type, _decode_type, _stream_reader_type, _stream_writer_type]
):
    def __init__(
        self,
        encode: _encode_type,
        decode: _decode_type,
        streamreader: _stream_reader_type = ...,
        streamwriter: _stream_writer_type = ...,
        incrementalencoder: _incremental_encoder_type = ...,
        incrementaldecoder: _incremental_decode_type = ...,
        name: str = ...,
    ) -> None:
        self.encode = encode
        self.decode = decode
...
def EncodedFile(
    file: BinaryIO, data_encoding: str, file_encoding: str = ..., errors: str = ...
) -> "StreamRecoder": ...
def iterencode(
...
class StreamReaderWriter:
    def __init__(
        self,
        stream: BinaryIO,
        Reader: _stream_reader_type,
        Writer: _stream_writer_type,
        errors: str = ...,
    ) -> None: ...
