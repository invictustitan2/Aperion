...
class staticmethod:
    pass  # Special, only valid as a decorator.
...
class str(basestring, Sequence[str]):
    ...
    def title(self) -> str: ...
    def translate(
        self, table: Optional[AnyStr], deletechars: AnyStr = ...
    ) -> AnyStr: ...
    def upper(self) -> str: ...
...
class bytearray(MutableSequence[int]):
    ...
    @overload
    def __init__(
        self, x: unicode, encoding: unicode, errors: unicode = ...
    ) -> None: ...
    @overload
...
def compile(
    source: Any, filename: unicode, mode: str, flags: int = 0, dont_inherit: int = 0
) -> Any: ...
...
def filter(function: Callable[[_T], Any], iterable: Iterable[_T]) -> List[_T]: ...
...
) -> List[_S]: ...  # TODO more than two iterables
@overload
...
def print(
    *values: Any, sep: unicode = " ", end: unicode = "\n", file: IO[Any] = ...
) -> None: ...
@overload
def pow(
    x: int, y: int
) -> Any: ...  # The return type can be int or float, depending on y.
@overload
...
@overload
def reduce(
    function: Callable[[_T, _S], _T], iterable: Iterable[_S], initializer: _T
) -> _T: ...
@overload
...
@overload
def round(
    number: float, ndigits: int
) -> float: ...  # Always return a float if given ndigits.
@overload
...
@overload
def zip(iter1: Iterable[_T1], iter2: Iterable[_T2]) -> List[Tuple[_T1, _T2]]: ...
@overload
def zip(
...
def zip(
    ...
    iter3: Iterable[_T3],
    iter4: Iterable[_T4],
) -> List[Tuple[_T1, _T2, _T3, _T4]]: ...  # TODO more than four iterables
def __import__(
    name: unicode,
...
class buffer(Sized):
    def __init__(
        self, object: AnyBuffer, offset: int = ..., size: int = ...
    ) -> None: ...
...
def eval(
    s: str, globals: Dict[str, Any] = ..., locals: Dict[str, Any] = ...
) -> Any: ...
def exec(
    object: str, globals: Dict[str, Any] = None, locals: Dict[str, Any] = None
) -> Any: ...  # TODO code object as source
def cmp(x: Any, y: Any) -> int: ...
def execfile(
    filename: str, globals: Dict[str, Any] = None, locals: Dict[str, Any] = None
) -> None: ...
...
class file(BinaryIO):
    ...
    @overload
    def __init__(
        self, file: unicode, mode: str = "r", buffering: int = ...
    ) -> None: ...
    @overload
...
# Very old builtins
def apply(
    func: Callable[..., _T], args: Sequence[Any] = None, kwds: Mapping[str, Any] = None
) -> _T: ...
