...
from typing import Any, Callable, Iterable, List, Sequence, TextIO, Tuple, TypeVar
...
class TestCase(Testable):
    ...
    def assertIsInstance(self, obj: Any, cls: type, msg: object = ...) -> None: ...
    def assertNotIsInstance(self, obj: Any, cls: type, msg: object = ...) -> None: ...
