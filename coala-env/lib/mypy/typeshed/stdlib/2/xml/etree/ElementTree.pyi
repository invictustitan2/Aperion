...
class _SimpleElementPath:
    def find(
        self, element: "Element", tag: _str_or_bytes, namespaces: Any = ...
    ) -> Optional["Element"]: ...
    def findtext(
        self,
        element: "Element",
...
class Element(Sequence["Element"]):
    ...
    def __init__(
        self,
        tag: Union[AnyStr, Callable[..., "Element"]],
        attrib: Dict[AnyStr, AnyStr] = ...,
        **extra: AnyStr
    ) -> None: ...
    ...
    def find(
        self, path: str, namespaces: Dict[str, str] = ...
    ) -> Optional["Element"]: ...
    def findall(
        self, path: str, namespaces: Dict[str, str] = ...
    ) -> List["Element"]: ...
    def findtext(
        self, path: str, default: _T = ..., namespaces: Dict[str, str] = ...
    ) -> Union[_T, str]: ...
...
def SubElement(
    parent: Element, tag: AnyStr, attrib: Dict[AnyStr, AnyStr] = ..., **extra: AnyStr
) -> Element: ...
...
class ElementTree:
    def __init__(
        self, element: Element = ..., file: _file_or_filename = ...
    ) -> None: ...
    def getroot(self) -> Element: ...
    def parse(
        self, source: _file_or_filename, parser: "XMLParser" = ...
    ) -> Element: ...
...
def tostringlist(
    element: Element, encoding: str = ..., method: str = ...
) -> List[str]: ...
def dump(elem: Element) -> None: ...
def parse(source: _file_or_filename, parser: "XMLParser" = ...) -> ElementTree: ...
def iterparse(
    source: _file_or_filename, events: Sequence[str] = ..., parser: "XMLParser" = ...
...
def fromstringlist(
    sequence: Sequence[AnyStr], parser: "XMLParser" = ...
) -> Element: ...

class TreeBuilder:
    def __init__(
        self, element_factory: Callable[[AnyStr, Dict[AnyStr, AnyStr]], Element] = ...
    ) -> None: ...
...
class XMLParser:
    ...
    version = ...  # type: str
    def __init__(
        self, html: int = ..., target: TreeBuilder = ..., encoding: str = ...
    ) -> None: ...
    ...
    def close(
        ...
        Any
    ): ...  # TODO-most of the time, this will be Element, but it can be anything target.close() returns
