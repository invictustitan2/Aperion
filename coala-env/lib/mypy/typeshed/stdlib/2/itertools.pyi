...
@overload
def islice(
    iterable: Iterable[_T], start: int, stop: Optional[int], step: int = ...
) -> Iterator[_T]: ...
...
) -> Iterable[_S]: ...  # TODO more than two iterables
...
@overload
def izip(iter1: Iterable[_T1], iter2: Iterable[_T2]) -> Iterable[Tuple[_T1, _T2]]: ...
@overload
def izip(
...
def izip(
    ...
    iter3: Iterable[_T3],
    iter4: Iterable[_T4],
) -> Iterable[Tuple[_T1, _T2, _T3, _T4]]: ...  # TODO more than four iterables
