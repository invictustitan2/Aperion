...
from typing import Dict, List, NamedTuple, Sequence, Tuple, Union, overload
...
def urlparse(
    url: Union[str, unicode], scheme: str = ..., allow_fragments: bool = ...
) -> ParseResult: ...
def urlsplit(
    url: Union[str, unicode], scheme: str = ..., allow_fragments: bool = ...
) -> SplitResult: ...
...
def urljoin(
    base: Union[str, unicode], url: Union[str, unicode], allow_fragments: bool = ...
) -> str: ...
...
def parse_qsl(
    qs: str, keep_blank_values: int = ..., strict_parsing: bool = ...
) -> List[Tuple[str, str]]: ...
