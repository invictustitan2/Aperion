...
from typing import IO, Any, AnyStr, List, Optional, Tuple, Union, overload
...
@overload
def mkstemp(
    suffix: AnyStr = ..., prefix: AnyStr = ..., dir: AnyStr = ..., text: bool = ...
) -> Tuple[int, AnyStr]: ...
@overload
def mkdtemp() -> str: ...
@overload
def mkdtemp(
    suffix: AnyStr = ..., prefix: AnyStr = ..., dir: AnyStr = ...
) -> AnyStr: ...
@overload
def mktemp() -> str: ...
@overload
