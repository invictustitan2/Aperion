...
class AbstractEventLoop(metaclass=ABCMeta):
    ...
    @abstractmethod
    def call_later(
        self, delay: Union[int, float], callback: Callable[[], Any], *args: Any
    ) -> Handle: ...
    @abstractmethod
    def call_at(
    ...
    @abstractmethod
    def run_in_executor(
        self, executor: Any, callback: Callable[[], Any], *args: Any
    ) -> Future[Any]: ...
    @abstractmethod
    ...
    def getaddrinfo(
        ...
        *,
        ...
        proto: int = ...,
        flags: int = ...
    ) -> Future[List[Tuple[int, int, int, str, tuple]]]: ...
    @abstractmethod
    def getnameinfo(
    ...
    @abstractmethod
    def add_reader(
        self, fd: int, callback: Callable[[], Any], *args: List[Any]
    ) -> None: ...
    @abstractmethod
    ...
    def add_signal_handler(
        self, sig: int, callback: Callable[[], Any], *args: List[Any]
    ) -> None: ...
    @abstractmethod
...
class AbstractEventLoopPolicy(metaclass=ABCMeta):
    ...
    def set_child_watcher(
        self, watcher: Any
    ) -> None: ...  # TODO: unix_events.AbstractChildWatcher
