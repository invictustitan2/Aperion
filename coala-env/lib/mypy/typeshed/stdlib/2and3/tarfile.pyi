...
from typing import IO, Callable, Iterator, List, Mapping, Optional, Type, Union
...
class TarFile:
    ...
    if sys.version_info >= (3, 5):
        ...
        def extractall(
            self, path: str = ..., members: Optional[List[TarInfo]] = ...
        ) -> None: ...
    if sys.version_info >= (3, 5):
        def extract(
            self,
        ...
        def extract(
            self, member: Union[str, TarInfo], path: str = ..., set_attrs: bool = ...
        ) -> None: ...
    else:
        def extract(self, member: Union[str, TarInfo], path: str = ...) -> None: ...
