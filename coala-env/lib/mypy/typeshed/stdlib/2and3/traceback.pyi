...
from typing import IO, Generator, Iterator, Mapping, Optional, Tuple, Type

_PT = Tuple[str, int, str, Optional[str]]

def print_tb(
    tb: TracebackType, limit: Optional[int] = ..., file: Optional[IO[str]] = ...
) -> None: ...
...
def format_exception_only(
    etype: Type[BaseException], value: BaseException
) -> List[str]: ...
