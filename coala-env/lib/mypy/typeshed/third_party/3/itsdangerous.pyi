...
class SigningAlgorithm:
    ...
    def verify_signature(
        self, key: bytes_like, value: bytes_like, sig: can_become_bytes
    ) -> bool: ...
...
class Signer:
    ...
    def __init__(
        self,
        secret_key: can_become_bytes,
        salt: Optional[can_become_bytes] = None,
        sep: Optional[can_become_bytes] = "",
...
class TimestampSigner(Signer):
    ...
    def unsign(
        self,
        value: can_become_bytes,
        max_age: Optional[int] = None,
        return_timestamp=False,
    ) -> Any: ...
    def validate(
        self, signed_value: can_become_bytes, max_age: Optional[int] = None
    ) -> bool: ...
...
class Serializer:
    ...
    def __init__(
        self,
        secret_key: can_become_bytes,
        salt: Optional[can_become_bytes] = b"",
        serializer=None,
    ...
    def dump(
        self, obj: Any, f: IO, salt: Optional[can_become_bytes] = None
    ) -> None: ...
    def loads(
        self, s: can_become_bytes, salt: Optional[can_become_bytes] = None
    ) -> Any: ...
...
class TimedJSONWebSignatureSerializer(JSONWebSignatureSerializer):
    ...
    expires_in = ...  # type: int
    def __init__(
        self, secret_key: can_become_bytes, expires_in: Optional[int] = None, **kwargs
    ) -> None: ...
    def make_header(self, header_fields=Optional[MutableMapping]) -> MutableMapping: ...
    def loads(
        self,
