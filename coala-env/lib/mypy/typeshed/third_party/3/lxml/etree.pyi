...
import typing
from typing import Any, Dict, Iterable, Iterator, List, SupportsBytes, Tuple, Union
...
class _ElementTree:
    def write(
        ...
        exclusive: bool = ...,
        with_comments: bool = ...,
        inclusive_ns_prefixes: ListAnyStr = ...,
    ) -> None:
        pass
...
class XSLT:
    ...
    def __call__(
        ...
        profile_run: bool = ...,
        **kwargs: Union[AnyStr, _XSLTQuotedStringParam]
    ) -> _XSLTResultTree:
        pass
...
def Element(
    _tag: AnyStr, attrib: DictAnyStr = ..., nsmap: DictAnyStr = ..., **extra: AnyStr
) -> _Element:
    pass
...
def parse(
    source: Union[AnyStr, typing.IO], parser: XMLParser = ..., base_url: AnyStr = ...
) -> _ElementTree:
    pass

def fromstring(
    text: AnyStr, parser: XMLParser = ..., *, base_url: AnyStr = ...
) -> _Element: ...
def tostring(
...
class DTD(_Validator):
    def __init__(
        self, file: Union[AnyStr, typing.IO] = ..., *, external_id: Any = ...
    ) -> None: ...
