...
class Environment:
    ...
    @overload
    def obtain(
        self, requirement: Requirement, installer: Callable[[Requirement], _T] = ...
    ) -> _T: ...
...
class Distribution(IResourceProvider, IMetadataProvider):
    ...
    @classmethod
    def from_filename(
        cls, filename: str, metadata: Optional[str] = ..., **kw: Union[str, None, int]
    ) -> Distribution: ...
...
def resource_string(package_or_requirement: _PkgReqType, resource_name: str) -> str: ...
...
class IResourceManager:
    ...
    def get_cache_path(
        self, archive_name: str, names: Tuple[str, ...] = ...
    ) -> str: ...
...
def register_loader_type(
    loader_type: type, provider_factory: Callable[[types.ModuleType], IResourceProvider]
) -> None: ...
