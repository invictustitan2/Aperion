...
def connect_ec2_endpoint(
    url, aws_access_key_id=..., aws_secret_access_key=..., **kwargs
): ...
def connect_walrus(
    host=...,
    aws_access_key_id=...,
...
def connect_ia(
    ia_access_key_id=..., ia_secret_access_key=..., is_secure=..., **kwargs
): ...
...
def connect_cloudsearch2(
    aws_access_key_id=..., aws_secret_access_key=..., sign_request=..., **kwargs
): ...
