...
from typing import IO, Any, Callable, Dict, Iterable, List, Union
...
def DEFINE_string(
    name: str, default: str, help: str, flag_values: FlagValues = ..., **args: Any
): ...
...
class BooleanFlag(Flag):
    def __init__(
        self, name: str, default: bool, help: str, short_name=..., **args: Any
    ) -> None: ...

def DEFINE_boolean(
    name: str, default: bool, help: str, flag_values: FlagValues = ..., **args: Any
) -> None: ...
...
def DEFINE_list(
    name: str, default: List[str], help: str, flag_values: FlagValues = ..., **args: Any
) -> None: ...
...
def DEFINE_multi_float(
    name: str,
    default: Union[float, List[float]],
    help: str,
    lower_bound: float = ...,
    upper_bound: float = ...,
    flag_values: FlagValues = ...,
