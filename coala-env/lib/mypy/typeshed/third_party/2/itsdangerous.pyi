...
from typing import IO, Any, Callable, MutableMapping, Optional, Text, Tuple, Union
...
class BadTimeSignature(BadSignature):
    ...
    def __init__(
        self, message, payload: Optional[Any] = None, date_signed: Optional[int] = None
    ) -> None: ...
...
class BadHeader(BadSignature):
    ...
    def __init__(
        self, message, payload=None, header=None, original_error=None
    ) -> None: ...
...
class SigningAlgorithm:
    ...
    def verify_signature(
        self, key: bytes_like, value: bytes_like, sig: bytes_like
    ) -> bool: ...
...
class Signer:
    ...
    def __init__(
        self,
        secret_key: bytes_like,
        salt: Optional[bytes_like] = None,
        sep: Optional[str] = "",
...
class TimestampSigner(Signer):
    ...
    def sign(self, value: bytes_like) -> str: ...
    def unsign(
        self, value: str, max_age: Optional[int] = None, return_timestamp=False
    ) -> Any: ...
...
class Serializer:
    ...
    def __init__(
        self,
        secret_key: bytes_like,
        salt: Optional[bytes_like] = b"",
        serializer=None,
        signer: Optional[Callable[..., Signer]] = None,
    ...
    def loads_unsafe(
        self, s, salt: Optional[bytes_like] = None
    ) -> Tuple[bool, Any]: ...
...
class TimedSerializer(Serializer):
    ...
    def loads_unsafe(
        self, s: str, salt: Optional[bytes_like] = None, max_age: Optional[int] = None
    ) -> Tuple[bool, Any]: ...
...
class JSONWebSignatureSerializer(Serializer):
    ...
    def make_signer(
        self, salt: Optional[bytes_like] = None, algorithm_name: Optional[str] = None
    ) -> Signer: ...
    ...
    def dumps(
        ...
        obj: Any,
        salt: Optional[bytes_like] = None,
        header_fields=Optional[MutableMapping],
    ) -> str: ...
    def loads(
        self, s: str, salt: Optional[bytes_like] = None, return_header=False
    ) -> Any: ...
    def loads_unsafe(
        self, s, salt: Optional[bytes_like] = None, return_header=False
    ) -> Tuple[bool, Any]: ...
...
class TimedJSONWebSignatureSerializer(JSONWebSignatureSerializer):
    ...
    expires_in = ...  # type: int
    def __init__(
        self, secret_key: bytes_like, expires_in: Optional[int] = None, **kwargs
    ) -> None: ...
    def make_header(self, header_fields=Optional[MutableMapping]) -> MutableMapping: ...
    def loads(
        self, s: str, salt: Optional[bytes_like] = None, return_header=False
