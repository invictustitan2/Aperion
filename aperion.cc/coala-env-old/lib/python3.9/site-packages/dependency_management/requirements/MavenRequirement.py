...
class MavenRequirement(PackageRequirement):
    ...
    def __init__(
        self, package, version: str, repo="https://repo.maven.apache.org/maven2"
    ):
        """
        ...
        if not package_match:
            raise ValueError("The package must be of the form [groupId:artifactId]")
    ...
    def is_installed(self):
        ...
        """
        return not run(
            "mvn dependency:get -Dartifact={}:{} --offline".format(
