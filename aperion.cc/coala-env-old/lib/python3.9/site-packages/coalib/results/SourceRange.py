...
class SourceRange(TextRange):
    ...
    @classmethod
    def from_values(
        cls, file, start_line=None, start_column=None, end_line=None, end_column=None
    ):
    ...
    def expand(self, file_contents):
        ...
        return SourceRange.from_values(
            self.file, tr.start.line, tr.start.column, tr.end.line, tr.end.column
        )
    ...
    def __str__(self):
        ...
        if self.start.line is None and self.end.line is None:
            ...
            format_str = (
                "{0.start.file}: L{0.start.line} C{0.start.column}"
