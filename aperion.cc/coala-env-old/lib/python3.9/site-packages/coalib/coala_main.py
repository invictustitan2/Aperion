...
from coalib.misc.CachingUtilities import (get_settings_hash, settings_changed,
                                          update_settings_db)
...
def run_coala(
    ...
    log_printer = (
        LogPrinter(ConsolePrinter(), LOG_LEVEL.DEBUG)
    ...
    try:
        ...
        sections, local_bears, global_bears, targets = gather_configuration(
            acquire_settings, log_printer, arg_parser=arg_parser, arg_list=arg_list
        )

        log_printer.debug(
            "Platform {} -- Python {}, coalib {}".format(
        ...
        flush_cache = bool(
            sections["cli"].get("flush_cache", False)
        ...
        for section_name, section in sections.items():
            ...
            yielded, yielded_unfixed, results[section_name] = simplify_section_result(
                section_result
            )
