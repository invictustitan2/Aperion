...
class BuildManPage(Command):
    ...
    user_options = [
        ...
        (
            "parser=",
            None,
            "module path to an ArgumentParser instance"
    ...
    def run(self):
        ...
        sections = {
            "see also": ("Online documentation: {}".format(homepage)),
...
class ManPageFormatter(argparse.HelpFormatter):
    ...
    def _format_action_invocation(self, action):
        if not action.option_strings:
            ...
            #    -s ARGS, --long ARGS
                ...
                parts = [
                    "%s %s" % (self._bold(option_string), args_string)
    ...
    def _mk_title(self):
        return ".TH {0} {1} {2}\n".format(self._prog, self._section, self._today)
    ...
    def _mk_synopsis(self):
        ...
        usage = self._format_usage(
            None, self._parser._actions, self._parser._mutually_exclusive_groups, ""
        )

        usage = usage.replace("%s " % self._prog, "")
        usage = ".SH SYNOPSIS\n \\fB%s\\fR %s\n" % (
            ManPageFormatter._markup(self._prog),
            usage,
        )
        return usage
