...
def get_data_path(log_printer, identifier):
    ...
    try:
        ...
        log_printer.err(
            "Unable to create user data directory '{}'. Continuing"
...
def delete_files(log_printer, identifiers):
    ...
    if len(error_files) > 0:
        ...
        log_printer.warn(
            "There was a problem deleting the following "
...
def pickle_load(log_printer, identifier, fallback=None):
    ...
    with open(file_path, "rb") as f:
        try:
            ...
            log_printer.warn("The given file is corrupted and will be " "removed.")
...
def get_settings_hash(
    sections, targets=[], ignore_settings: list = ["disable_caching"]
):
    """
...
def settings_changed(log_printer, settings_hash):
    ...
    if result:
        ...
        log_printer.debug(
            "Since the configuration settings have "
