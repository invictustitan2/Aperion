...
"""
    ...
    arg_parser.add_argument(
        "TARGETS", nargs="*", help="sections to be executed exclusively"
    )
    ...
    config_group.add_argument(
        "--flush-cache", const=True, action="store_const", help="rebuild the file cache"
    )
    config_group.add_argument(
        "--no-autoapply-warn",
        const=True,
    ...
    inputs_group.add_argument(
        "-b", "--bears", nargs="+", metavar="NAME", help="names of bears to use"
    ).completer = lambda *args, **kwargs: get_all_bears_names()  # pragma: no cover

    inputs_group.add_argument(
        "-f", "--files", nargs="+", metavar="FILE", help="files that should be checked"
    )

    inputs_group.add_argument(
        "-i", "--ignore", nargs="+", metavar="FILE", help="files that should be ignored"
    )
    ...
    outputs_group.add_argument(
        ...
        metavar="ENUM",
        help="set log output level to DEBUG/INFO/WARNING/ERROR, " "defaults to INFO",
    )
    ...
    outputs_group.add_argument(
        "-B", "--show-bears", const=True, action="store_const", help="list all bears"
    )
    ...
    outputs_group.add_argument(
        ...
        const=True,
        action="store_const",
        help="output logs as json along with results" " (must be called with --json)",
    )
