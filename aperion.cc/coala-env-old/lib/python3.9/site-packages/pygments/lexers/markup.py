...
from pygments.lexer import (DelegatingLexer, RegexLexer, bygroups, default,
                            do_insertions, include, this, using, words)
    ...
    tokens = {
        "root": [
            ...
            (
                r"^(?:( *)([+-] )|( +)(\* ))(\[[ X-]\])?(.+ ::)?",
                bygroups(
                    Whitespace, Keyword, Whitespace, Keyword, Generic.Prompt, Name.Label
                ),
            ),
            # Ordered list items
            (
            ...
            (
                r"(?s)(\[\[)(.*?)(\]\[)(.*?)(\]\])",
                bygroups(
                    Punctuation, Name.Attribute, Punctuation, Name.Tag, Punctuation
                ),
            ),
            (
                r"(?s)(\[\[)(.+?)(\]\])",
    ...
    tokens = {
        ...
        "inline": [
            ...
            (
                ...
                """,
                bygroups(
                    Punctuation, using(this, state=["root", "lc-flag"]), Punctuation
                ),
                "lc-raw",
            ),
