...
from pygments.lexers import (ClassNotFound, _googlesql_builtins,
                             _tsql_builtins, get_lexer_by_name)
from pygments.lexers._mysql_builtins import (MYSQL_CONSTANTS, MYSQL_DATATYPES,
                                             MYSQL_FUNCTIONS, MYSQL_KEYWORDS,
                                             MYSQL_OPTIMIZER_HINTS)
from pygments.lexers._postgres_builtins import (DATATYPES, EXPLAIN_KEYWORDS,
                                                KEYWORDS, PLPGSQL_KEYWORDS,
                                                PSEUDO_TYPES)
