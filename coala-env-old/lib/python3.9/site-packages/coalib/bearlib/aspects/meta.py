    ...
    def subaspect(cls, subcls):
        ...
        aspectdocs = Documentation(
            ...
            **{
                ...
                for attr in list(signature(Documentation).parameters.keys())[1:]
            }
        )
...
class aspectTypeError(TypeError):
    ...
    def __init__(self, item):
        self.item = item
        message = "{} is not an aspectclass or an instance of an " "aspectclass".format(
            repr(self.item)
        )
...
def issubaspect(subaspect, aspect):
    ...
    aspect_qualname = (
        ...
        else type(aspect).__qualname__
    )
    subaspect_qualname = (
        subaspect.__qualname__
        if isinstance(subaspect, aspectclass)
        else type(subaspect).__qualname__
    )
