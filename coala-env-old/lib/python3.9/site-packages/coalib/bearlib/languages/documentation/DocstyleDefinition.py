...
class DocstyleDefinition:
    ...
    @enforce_signature
    def __init__(
        self, language: str, docstyle: str, markers: (Iterable, str), metadata: Metadata
    ):
        """
        ...
        for marker_set in self._markers:
            ...
            if length != 3:
                raise ValueError(
                    "Length of a given marker set was not 3 (was "
    ...
    def load(cls, language: str, docstyle: str, coalang_dir=None):
        ...
        try:
            ...
            raise FileNotFoundError(
                "Docstyle definition " + repr(docstyle) + " not found."
            )
        ...
        metadata = cls.Metadata(
            *(
                str(docstyle_settings.get(req_setting, ""))
        ...
        marker_sets = (
            tuple(value)
            for key, value in docstyle_settings.contents.items()
