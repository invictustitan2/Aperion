...
from dependency_management.requirements.AnyOneOfRequirements import AnyOneOfRequirements
from dependency_management.requirements.ExecutableRequirement import (
    ExecutableRequirement,
)
from dependency_management.requirements.PackageRequirement import PackageRequirement
...
class DistributionRequirement(PackageRequirement):
    ...
    def __init__(self, package: str = None, version="", repo="", **package_overrides):
        """
    ...
    def available_package_managers(self):
        ...
        if self._available_managers is None:
            self._available_managers = list(self.get_all_available_package_managers())
    ...
    def get_all_available_package_managers(self):
        ...
        raise NotImplementedError(
            ...
            "manager(s): {}".format(", ".join(self.SUPPORTED_PACKAGE_MANAGERS))
        )
    ...
    def is_installed(self):
        ...
        return not run(
            command.format(package), stdout=Capture(), stderr=Capture()
        ).returncode
